...
EXPECTED_HTML_SHA256 = 'f2fd320da52a1e6e28408163443cf9d58f86b3c7c6cb814019a731a075e9c29b'
checks = {
    'HTML exact hash': hashlib.sha256(html).hexdigest() == EXPECTED_HTML_SHA256,
    ...
    'project provenance marker': 'YDI-PROVENANCE-0.1.0-6B8A4C2E' in main and 'YDI-PROVENANCE-0.1.0-6B8A4C2E' in html_path.read_text(encoding='utf-8'),
